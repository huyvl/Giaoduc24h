...
CREATE TABLE `permissions` (
  ...
  `module` varchar(225) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `users` (
  ...
  `active_role` varchar(225) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
-- Dump completed on 2017-08-16 14:58:33
